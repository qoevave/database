...
- [Asset Catalogue](https://zenodo.org/records/11060449/files/AssetsCatalogue.xlsx?download=1)
...
- [**<u>Path creator</u>**](https://github.com/SebLague/Path-Creator) v1.2
...
- Assets authored by the FAU for the CGI Scenes Database is Licensed under the [CC BY-NC-SA 4.0] License.
A comprehensive asset list can be found at the top of this page, or on the download page.
